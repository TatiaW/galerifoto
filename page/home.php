...
<div id="carouselExampleIndicators" class="carousel slide">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="assets/img/beranda1.png" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="assets/img/beranda2.png" class="d-block w-100" alt="...">
    </div>
  </div>
        ...
        <div class="col-6 col-md-4 col-lg-3 mb-4">
            <div class="card mb-3">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text text-muted">From: @ <?= $tampils['Username'] ?></p>
