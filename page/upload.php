<div class="container mt-3 mb-3">
    <div class="row">
        <div class="col-5">
            <div class="card">
            <h5 class="card-header">Upload Foto Anda Disini </h5>
                <div class="card-body">
                    ...
                    if ($submit == 'Simpan') {
                        ...
                        if ($submit == "Ubah") {
                            ...
                            if (strlen($nama_file) == 0) {
                                ...
                                if ($update) {
                                    echo "<script> alert ('Foto Berhasil Di Ubah');</script>";
                                    echo '<meta http-equiv="refresh" content="0.8; url=?url=upload">';
                                } else {
                        ...
                        if ($delete) {
                            ...
                            echo "<script> alert ('Foto Gagal Di Hapus');</script>";
                            echo '<meta http-equiv="refresh" content="0.8; url=?url=upload">';
                        }
                    }
                    //mencari data album
                    ...
                    <?php if (!isset($_GET['edit'])) : ?>
                        <form action="?url=upload" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-1">
                                ...
                                <textarea name="deskripsi_foto" class="form-control" required rows="3"></textarea>
                            </div>
                            <div class="mb-1">
                            ...
                            <input type="submit" value="Simpan" name="submit" class="btn btn-primary my-3 mt-2 mb-0">
                        </form>
                    <?php elseif (isset($_GET['edit'])) : ?>
                        <form action="?url=upload&&edit&&fotoid=<?= $val['FotoID'] ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-1">
                                <label class="form-label">Deskripsi Foto</label>
                                <textarea name="deskripsi_foto" class="form-control" required  rows="3"><?= $val['DeskripsiFoto'] ?></textarea>
                            </div>
                            <div class="mb-1">
                            ...
                            <input type="submit" value="Ubah" name="submit" class="btn btn-primary my-3 mt-2 mb-0">
                        </form>
                    <?php endif; ?>
                </div>
            </div>
